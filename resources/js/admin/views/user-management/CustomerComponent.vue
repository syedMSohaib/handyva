            ...
            <div class="row align-items-center mt-2">
                ...
                <div
                    ...
                    <a href="javascript:;" @click="blocked = !blocked" class="red-btn blocked d-inline py-1">
                        {{ !blocked? 'Blocked Customer': 'Active Customer'}}</a>
                                ...
                                <div class="btn-group mr-1 mb-1">
                                    ...
                                    <div class="dropdown-menu" x-placement="bottom-start"
                                        ...
                                        <router-link class="dropdown-item"
                                            :to="{ name: 'usermg.customer.show', params: { id: row.id } }">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            blockRow(id) {
                this.$dialog.confirm(`Are you sure you want to ${this.blocked? 'unblock': 'block'} this customer?`).then(
                    dialog => {
        ...
        watch: {
            'blocked': function () {
                document.title = (this.blocked) ? `${window.appname} - Blocked Customer` :
                    `${window.appname} - Active Customer`
                this.getclients()
            }
        }
    }
