						...
						<ul class="navbar-nav header-right main-notification">
							...
							<li class="nav-item dropdown header-profile">
								...
								<div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <form method="post" :action="`${baseUrl}/admin/logout`" id="logoutFrom"></form>
									<a href="javascript:;" onclick="document.getElementById('logoutFrom').submit()" class="dropdown-item ai-icon">
